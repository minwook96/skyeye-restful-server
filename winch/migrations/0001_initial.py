...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='WinchDataLog',
            fields=[
                ('winch_data_log_id', models.AutoField(help_text='auto increment PK', primary_key=True, serialize=False)),
                ('date', models.DateTimeField(blank=True, help_text='날짜', null=True)),
                ...
                ('rainfall', models.IntegerField(blank=True, help_text='강우', null=True)),
