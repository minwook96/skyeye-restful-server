...
class WinchDataLog(models.Model):
    winch_data_log_id = models.AutoField(primary_key=True, help_text='auto increment PK')
    winch_serial_number = models.ForeignKey(Winch, models.DO_NOTHING, db_column='winch_serial_number', blank=True,
                                            null=True, help_text='윈치 일련번호')
    ...
    rainfall = models.IntegerField(blank=True, null=True, help_text='강우')
